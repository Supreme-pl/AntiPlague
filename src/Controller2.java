...
public class Controller2 {
    ...
    Cure2 vaccine = new Cure2(); // cure thread

    public Controller2(View2 v, Country m, HighScores h)
    {
        view = v;
        country = m;
        highScores = h;
    ...
    public void updateTransport() {
        info = new Timer(1000, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(flagPl && poland.getVirus().getVirusProgress()/10 > 40000)
                {
                ...
                if(flagUk && uk.getVirus().getVirusProgress()/10 > 60000)
                {
                ...
                if(flagUa && ukraine.getVirus().getVirusProgress()/10 > 40000)
                {
                ...
                if(flagIt && italy.getVirus().getVirusProgress()/10 > 21000)
                {
                ...
                if(flagFr && france.getVirus().getVirusProgress()/10 > 60000)
                {
                ...
                if(flagGr && greece.getVirus().getVirusProgress()/10 > 10000)
                {
    ...
    public void updateLabels() {
        JOptionPane.showMessageDialog(null, "Unidentified virus spotted in Hubei, China has been brought to Europe.",
        ...
        checkMoney = new Timer(1000, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                else view.getBuy5().setEnabled(false);
                if (money >= 600 && vaccine.cureProgress==100)
    ...
    public void controlButtons() {
        ...
        view.getBuy().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                money = (int) (money + (Math.random()) * 75);
        ...
        view.getBuy5().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                v = new Timer(3000, new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
                        view.cure.setText("Cure: "+vaccine.cureProgress+"%");
                        if (vaccine.cureProgress >= 100 && money >= 600)
                            view.getBuy6().setEnabled(true);
                    }
                });
                v.start();
