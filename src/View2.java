...
public class View2 extends JFrame {
    ...
    public View2() {
        ...
        frame = new JFrame("Anti-PlaGUI (Harder mode)");
...
//        day.setBackground(Color.decode("#00261F2E"));
        ...
        JLabel cost1 = new JLabel("Cost: 30");
        ...
        JLabel cost2 = new JLabel("Cost: 60");
        ...
        JLabel cost3 = new JLabel("Cost: 150");
        ...
        JLabel cost4 = new JLabel("Cost: 210");
        ...
        JLabel cost5 = new JLabel("Cost: 360");
        ...
        JLabel cost6 = new JLabel("Cost: 600");
        ...
        JLabel cost7 = new JLabel("Cost: 150");
        ...
        JLabel cost8 = new JLabel("Cost: 900");
    ...
    public JLabel getCure() {
        return cure;
    }

    public JPanel getTransportInfos() {
